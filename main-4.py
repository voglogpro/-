...
# ============================================================
# Порт НАШЕГО веб-сервера. ВАЖНО: берём отдельный порт (по умолчанию 3000),
# а НЕ BotHost'овский PORT=8080 — там сидит их собственный агент.
...
# ТЕСТ: юзернейм бота для кнопок в группе (A и B).
BOT_USERNAME = os.getenv("BOT_USERNAME", "BbGalterbot")
...
# ============================================================
LEVEL_TITLES = [
    (1, "Новичок"), (3, "Гонщик"), (6, "Профи"), (10, "Легенда"),
]
